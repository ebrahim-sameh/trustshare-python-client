...
class InboundsApi(object):
    ...
    def get_inbound(self, authorization, id, **kwargs):  # noqa: E501
        """Get an Inbound  # noqa: E501

        Retrieve an inbound payment.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_inbound(authorization, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str authorization: Your API Key in the format `[sandbox|live]_api_[0-9a-z]`. (required)
        :param str id: A unique ID of an existing inbound.  A string in the format: `inbound_[0-9a-z]` (required)
        :return: Inbound
        ...
        if kwargs.get('async_req'):
            return self.get_inbound_with_http_info(authorization, id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_inbound_with_http_info(authorization, id, **kwargs)  # noqa: E501
            return data

    def get_inbound_with_http_info(self, authorization, id, **kwargs):  # noqa: E501
        """Get an Inbound  # noqa: E501

        Retrieve an inbound payment.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_inbound_with_http_info(authorization, id, async_req=True)
        >>> result = thread.get()
        ...
        if ('authorization' not in params or
            ...
            raise ValueError("Missing the required parameter `authorization` when calling `get_inbound`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_inbound`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='Inbound',  # noqa: E501
