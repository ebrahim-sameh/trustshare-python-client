...
class CheckoutsApi(object):
    ...
    def get_checkout(self, authorization, id, **kwargs):  # noqa: E501
        """Get a Checkout  # noqa: E501

        Retrieve an existing checkout.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_checkout(authorization, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str authorization: Your API Key in the format `[sandbox|live]_api_[0-9a-z]`. (required)
        :param str id: A unique ID of an existing checkout.  A string in the format: `checkout_[0-9a-z]` (required)
        :return: Checkout
        ...
        if kwargs.get('async_req'):
            return self.get_checkout_with_http_info(authorization, id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_checkout_with_http_info(authorization, id, **kwargs)  # noqa: E501
            return data

    def get_checkout_with_http_info(self, authorization, id, **kwargs):  # noqa: E501
        """Get a Checkout  # noqa: E501

        Retrieve an existing checkout.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_checkout_with_http_info(authorization, id, async_req=True)
        >>> result = thread.get()
        ...
        if ('authorization' not in params or
            ...
            raise ValueError("Missing the required parameter `authorization` when calling `get_checkout`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_checkout`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='Checkout',  # noqa: E501
