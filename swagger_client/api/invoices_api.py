...
class InvoicesApi(object):
    ...
    def get_invoice(self, authorization, id, **kwargs):  # noqa: E501
        """Get an Invoice  # noqa: E501

        Retrieve an existing invoice.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_invoice(authorization, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str authorization: Your API Key in the format `[sandbox|live]_api_[0-9a-z]`. (required)
        :param str id: A unique ID of an existing invoice.  A string in the format: `invoice_[0-9a-z]` (required)
        :return: Invoice
        ...
        if kwargs.get('async_req'):
            return self.get_invoice_with_http_info(authorization, id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_invoice_with_http_info(authorization, id, **kwargs)  # noqa: E501
            return data

    def get_invoice_with_http_info(self, authorization, id, **kwargs):  # noqa: E501
        """Get an Invoice  # noqa: E501

        Retrieve an existing invoice.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_invoice_with_http_info(authorization, id, async_req=True)
        >>> result = thread.get()
        ...
        if ('authorization' not in params or
            ...
            raise ValueError("Missing the required parameter `authorization` when calling `get_invoice`")  # noqa: E501
