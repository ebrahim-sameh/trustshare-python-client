...
class DepositIntent(object):
    ...
    discriminator_value_class_map = {
            'PaymentIntent'.lower(): '#/components/schemas/PaymentIntent',
            'LinkIntent'.lower(): '#/components/schemas/LinkIntent',
    }

    def __init__(self):  # noqa: E501
        """DepositIntent - a model defined in Swagger"""  # noqa: E501
        self.discriminator = 'typename'
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DepositIntent, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DepositIntent):
            return False
