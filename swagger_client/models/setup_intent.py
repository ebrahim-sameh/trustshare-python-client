...
class SetupIntent(object):
    ...
    discriminator_value_class_map = {
            'SessionIntent'.lower(): '#/components/schemas/SessionIntent',
    }

    def __init__(self):  # noqa: E501
        """SetupIntent - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SetupIntent, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SetupIntent):
            return False
