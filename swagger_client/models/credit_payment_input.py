...
class CreditPaymentInput(object):
    ...
    def __init__(self, payment_instrument_id=None, terms=None):  # noqa: E501
        """CreditPaymentInput - a model defined in Swagger"""  # noqa: E501
    ...
    def payment_instrument_id(self):
        """Gets the payment_instrument_id of this CreditPaymentInput.  # noqa: E501

        A unique ID of an existing payment instrument.  A string in the format: `payment_instrument_[0-9a-z]`  # noqa: E501

        :return: The payment_instrument_id of this CreditPaymentInput.  # noqa: E501
        :rtype: str
        """
    ...
    def payment_instrument_id(self, payment_instrument_id):
        """Sets the payment_instrument_id of this CreditPaymentInput.

        A unique ID of an existing payment instrument.  A string in the format: `payment_instrument_[0-9a-z]`  # noqa: E501

        :param payment_instrument_id: The payment_instrument_id of this CreditPaymentInput.  # noqa: E501
        :type: str
        """
        if payment_instrument_id is None:
            raise ValueError("Invalid value for `payment_instrument_id`, must not be `None`")  # noqa: E501

        self._payment_instrument_id = payment_instrument_id

    @property
    def terms(self):
        """Gets the terms of this CreditPaymentInput.  # noqa: E501


        :return: The terms of this CreditPaymentInput.  # noqa: E501
        :rtype: CreditTerms
        """
        return self._terms
    ...
    def terms(self, terms):
        """Sets the terms of this CreditPaymentInput.


        :param terms: The terms of this CreditPaymentInput.  # noqa: E501
        :type: CreditTerms
        """
        if terms is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreditPaymentInput, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreditPaymentInput):
            return False
