...
class OutboundResult(object):
    ...
    def __init__(self, outbounds=None):  # noqa: E501
        """OutboundResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def outbounds(self):
        """Gets the outbounds of this OutboundResult.  # noqa: E501

        A list of outbounds created off the back of a release or refund.  # noqa: E501

        :return: The outbounds of this OutboundResult.  # noqa: E501
        :rtype: list[Outbound]
        """
    ...
    def outbounds(self, outbounds):
        """Sets the outbounds of this OutboundResult.

        A list of outbounds created off the back of a release or refund.  # noqa: E501

        :param outbounds: The outbounds of this OutboundResult.  # noqa: E501
        :type: list[Outbound]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OutboundResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OutboundResult):
            return False
