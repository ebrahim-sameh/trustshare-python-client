...
class CreditResult(object):
    ...
    def __init__(self, success=None):  # noqa: E501
        """CreditResult - a model defined in Swagger"""  # noqa: E501
        self._success = None
    ...
    @property
    def success(self):
        """Gets the success of this CreditResult.  # noqa: E501

        A boolean describing the result of the credit attempt.  # noqa: E501

        :return: The success of this CreditResult.  # noqa: E501
        :rtype: bool
        """
    ...
    def success(self, success):
        """Sets the success of this CreditResult.

        A boolean describing the result of the credit attempt.  # noqa: E501

        :param success: The success of this CreditResult.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreditResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreditResult):
            return False
