...
class OutboundPausedReason(object):
    ...
    allowed enum values
    """
    PENDING_PARTICIPANT_VERIFICATION = "pending_participant_verification"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """OutboundPausedReason - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OutboundPausedReason, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OutboundPausedReason):
            return False
