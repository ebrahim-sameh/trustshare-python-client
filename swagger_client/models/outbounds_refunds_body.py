...
class OutboundsRefundsBody(object):
    ...
    def __init__(self, refunds=None):  # noqa: E501
        """OutboundsRefundsBody - a model defined in Swagger"""  # noqa: E501
        self._refunds = None
    ...
    @property
    def refunds(self):
        """Gets the refunds of this OutboundsRefundsBody.  # noqa: E501

        A list of refunds to create.  # noqa: E501

        :return: The refunds of this OutboundsRefundsBody.  # noqa: E501
        :rtype: list[RefundInput]
        """
        return self._refunds

    @refunds.setter
    def refunds(self, refunds):
        """Sets the refunds of this OutboundsRefundsBody.

        A list of refunds to create.  # noqa: E501

        :param refunds: The refunds of this OutboundsRefundsBody.  # noqa: E501
        :type: list[RefundInput]
        """
        if refunds is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OutboundsRefundsBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OutboundsRefundsBody):
            return False
