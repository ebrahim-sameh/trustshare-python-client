...
class TransferSourceOrTargetInput(object):
    ...
    def __init__(self, project_id=None, settlement_id=None):  # noqa: E501
        """TransferSourceOrTargetInput - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def project_id(self):
        """Gets the project_id of this TransferSourceOrTargetInput.  # noqa: E501

        A unique ID for the project originating the funds being transfered.  A string in the format `project_[0-9a-z]`.  # noqa: E501

        :return: The project_id of this TransferSourceOrTargetInput.  # noqa: E501
        :rtype: str
        """
    ...
    def project_id(self, project_id):
        """Sets the project_id of this TransferSourceOrTargetInput.

        A unique ID for the project originating the funds being transfered.  A string in the format `project_[0-9a-z]`.  # noqa: E501

        :param project_id: The project_id of this TransferSourceOrTargetInput.  # noqa: E501
        :type: str
        """
    ...
    def settlement_id(self):
        """Gets the settlement_id of this TransferSourceOrTargetInput.  # noqa: E501

        A unique ID for the settlement originating the funds being transfered.  A string in the format `settlement_[0-9a-z]`.  # noqa: E501

        :return: The settlement_id of this TransferSourceOrTargetInput.  # noqa: E501
        :rtype: str
        """
    ...
    def settlement_id(self, settlement_id):
        """Sets the settlement_id of this TransferSourceOrTargetInput.

        A unique ID for the settlement originating the funds being transfered.  A string in the format `settlement_[0-9a-z]`.  # noqa: E501

        :param settlement_id: The settlement_id of this TransferSourceOrTargetInput.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TransferSourceOrTargetInput, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TransferSourceOrTargetInput):
            return False
