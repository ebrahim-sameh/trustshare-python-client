...
class CreditTerms(object):
    ...
    END_OF_MONTH_PLUS_THIRTY_DAYS = "end_of_month_plus_thirty_days"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """CreditTerms - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreditTerms, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreditTerms):
            return False
