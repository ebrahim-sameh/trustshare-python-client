...
class IdCreditBody(object):
    ...
    def __init__(self, amount=None, reference=None):  # noqa: E501
        """IdCreditBody - a model defined in Swagger"""  # noqa: E501
        self._amount = None
    ...
    @property
    def amount(self):
        """Gets the amount of this IdCreditBody.  # noqa: E501

        The amount to credit to the project in the lowest denomination for the intent's currency. ie, £1,000.00 should be provided as `100000`.  # noqa: E501

        :return: The amount of this IdCreditBody.  # noqa: E501
        :rtype: int
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this IdCreditBody.

        The amount to credit to the project in the lowest denomination for the intent's currency. ie, £1,000.00 should be provided as `100000`.  # noqa: E501

        :param amount: The amount of this IdCreditBody.  # noqa: E501
        :type: int
        """
        if amount is None:
    ...
    @property
    def reference(self):
        """Gets the reference of this IdCreditBody.  # noqa: E501

        The reference to use for the credit. With this value you can target an existing checkout or invoice.  References are in the format `C[A-Z0-9]`.  # noqa: E501

        :return: The reference of this IdCreditBody.  # noqa: E501
        :rtype: str
        """
    ...
    def reference(self, reference):
        """Sets the reference of this IdCreditBody.

        The reference to use for the credit. With this value you can target an existing checkout or invoice.  References are in the format `C[A-Z0-9]`.  # noqa: E501

        :param reference: The reference of this IdCreditBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IdCreditBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IdCreditBody):
            return False
