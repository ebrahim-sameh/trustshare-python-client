...
class OutboundFailureReason(object):
    ...
    allowed enum values
    """
    FX_AMOUNT_TOO_SMALL = "fx_amount_too_small"
    UNABLE_TO_DETERMINE_TARGET_ACCOUNT = "unable_to_determine_target_account"
    INVALID_REFERENCE = "invalid_reference"
    INVALID_TARGET_ACCOUNT_CREDENTIALS = "invalid_target_account_credentials"
    MISSING_PARTICIPANT_INFORMATION = "missing_participant_information"
    GENERIC_FAILURE_CONTACT_SUPPORT = "generic_failure_contact_support"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """OutboundFailureReason - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OutboundFailureReason, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OutboundFailureReason):
            return False
